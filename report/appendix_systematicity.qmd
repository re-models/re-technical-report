...
::: {.callout-note}
The results of this appendix can be reproduced with the following Jupyter notebook: [{{< var link.nb-systematicity >}}]({{< var link.nb-systematicity >}}).
:::
...
::: {#lem-grec}
The generalized relative effective content systematicity satisfies D4.1.
:::
...
Hence, $S_{grec}(\mathcal{T}^*) < S_{grec}(\mathcal{T})$ if $\mathcal{T}^*$ is an ad hoc extension of $\mathcal{T}$. This concludes the proof of @lem-grec.
:::
