...
df['% of fixed points in global optima'] = df['% of fixed points in global optima'].map(lambda x: f'{round(x,1):.1f}') 
df['% of global optima in fixed points'] = df['% of global optima in fixed points'].map(lambda x: f'{round(x,1):.1f}') 
