...
-->
- The relative shares of IE cases among fixed points from all branches in local model variants (@fig-IE-fp-pp) are slightly boosted in comparison to the consideration of unique fixed points (@fig-IE-fp-rp).
